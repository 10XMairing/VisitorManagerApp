...
export default {
  ...
  GMAIL_OAUTH: {
    ...
    type: "oauth2",
    cliendid:
      "950339655299-ug2081au8iivjgk1ukiqc4fj0ru63q5p.apps.googleusercontent.com",
    client_secret: "uG-BAV6yKIxU-VsRJYdFGLQU ",
    refresh_token:
      "1//04Wtm-nwf1U_xCgYIARAAGAQSNwF-L9IrUBRfF7ahvaQ4wFi9fhLqunC9C6UNjspOyTQUUJQ9As9pN5eGUAK-MGa3twOw1EJ1DRs",
